                    ...
                    <div class="row m-auto d-flex justify-content-between">       
                        ...
                        <div class="col-xl-4 col-md-4 p-3">
                            ...
                            <?php $category_count = $this->Manage_model->countCategoryByOffice($office_id); ?>
                                <div class="card-body">
                                    Total Category : <b><?php echo $category_count; ?> records</b>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" 
                                        href="<?= base_url('Management/showCategory/' . ($office_id ?? '')) ?>">
                                        View as Table
                                </a>
                        ...
                        <div class="col-xl-4 col-md-4  p-3">
                                        ...
                                        <?php $content_count = $this->Manage_model->countContentByOffice($office_id);?>
                                            ...
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="<?= base_url('Management/showcontent/' . ($office_id ?? '')) ?>">View as Table</a>
                                            <!-- <a class="small text-white stretched-link" href="<?= base_url('Management/showcontent/2') ?>">View as Table</a> -->
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                            </div>
                                        </div>
                        </div>
